...
export default function App() {
  ...
  return (
    ...
    <div className={`min-h-screen ${darkMode ? "dark bg-gray-900 text-black" : "bg-blue-100 text-black"}`}
    >
      
     
      <header className={`p-4 flex gap-[50%] justify-center items-center shadow-md ${darkMode ? "bg-gray-800 text-white" : "bg-white text-black"}`}>
      
        <h1 className="text-xl font-bold">🌎THE GLOBE</h1>
        ...
        <button
          ...
          className="py-2 px-4 bg-[#6c757d] text-black rounded hover:bg-blue-600"
        >
